...
let workspacePanelMode = 'coloring';
let replacementSelectedColors = new Set();
let replacementTargetColor = null;
let replacementTargetMode = false;
let replacementOrderedColors = [];
...
let isReplicationMarking = false;
let replicationMarkingChanged = false;
let replicationPreviewMode = 'target';
let colorBeforeReplication = null;
